...
export default function DiagnosticsPage() {
  ...
  const diagnosticOptions = [
    ...
    },
    {
      ...
      action: () => {
        sessionStorage.setItem("kioskDiagnosticType", "CT");
        navigate('/identify');
      }
    },
    {
      ...
      action: () => {
        sessionStorage.setItem("kioskDiagnosticType", "X-Ray");
        navigate('/identify');
      }
    },
    {
      ...
      action: () => {
        sessionStorage.setItem("kioskDiagnosticType", "USG");
        navigate('/identify');
      }
    }
  ];
        ...
        <Card className="p-6 bg-muted/30 border-0">
          <div className="text-center">
            <p className="text-sm text-muted-foreground mb-3">
              <strong>What to expect:</strong> After selecting your service, you'll verify your identity and receive scheduling options.
            </p>
