...
//   const uiLang = getStoredLanguage(); // e.g. "en", "hi-IN"
//   const whisperLang = useMemo(
//     () => mapUiLangToWhisper(uiLang),
//     [uiLang]
//   );
...
//     {
//       id: "general-checkup",
//       title: t("reason.options.generalCheckup", "General Check-up"),
//       icon: Heart,
//       category: "General",
//     },
//     {
//       id: "fever-cold",
//       title: t("reason.options.feverCold", "Fever / Cold"),
//       icon: Heart,
//       category: "General",
//     },
//     {
//       id: "headache",
//       title: t("reason.options.headache", "Headache"),
//       icon: Brain,
//       category: "Neurological",
//     },
//     {
//       id: "back-pain",
//       title: t("reason.options.backPain", "Back Pain"),
//       icon: Bone,
//       category: "Orthopedic",
//     },
//     {
//       id: "joint-pain",
//       title: t("reason.options.jointPain", "Joint Pain"),
//       icon: Bone,
//       category: "Orthopedic",
//     },
//     {
//       id: "eye-problem",
//       title: t("reason.options.eyeProblem", "Eye Problem"),
//       icon: Eye,
//       category: "Ophthalmology",
//     },
//     {
//       id: "skin-issue",
//       title: t("reason.options.skinIssue", "Skin Issue"),
//       icon: Heart,
//       category: "Dermatology",
//     },
//     {
//       id: "stomach-pain",
//       title: t("reason.options.stomachPain", "Stomach Pain"),
//       icon: Heart,
//       category: "Gastroenterology",
//     },
//     {
//       id: "diabetes",
//       title: t("reason.options.diabetes", "Diabetes Check"),
//       icon: Pill,
//       category: "Endocrinology",
//     },
//     {
//       id: "blood-pressure",
//       title: t("reason.options.bloodPressure", "Blood Pressure"),
//       icon: Heart,
//       category: "Cardiology",
//     },
//     {
//       id: "pregnancy",
//       title: t("reason.options.pregnancy", "Pregnancy Related"),
//       icon: Heart,
//       category: "Gynecology",
//     },
//     {
//       id: "follow-up",
//       title: t("reason.options.followUp", "Follow-up Visit"),
//       icon: Plus,
//       category: "General",
//     },
//   ];
...
//       toast({
//         title: t(
//           "reason.voiceRecordingStartedTitle",
//           "Recording Started"
//         ),
//         description: t(
//           "reason.voiceRecordingStartedDesc",
...
//       toast({
//         title: t(
//           "reason.voiceRecordingStoppedTitle",
//           "Recording Stopped"
//         ),
//         description: t(
//           "reason.voiceRecordingStoppedDesc",
...
//       toast({
//         variant: "destructive",
//         title: t("reason.reasonRequiredTitle", "Reason Required"),
//         description: t(
//           "reason.reasonRequiredDesc",
...
//         customReason: customReason.trim(),
//         voice: {
//           used: isRecording || Boolean(customReason.trim()),
//           lang: whisperLang || "auto",
//         },
//         timestamp: new Date().toISOString(),
//       };
//       localStorage.setItem(
//         "medmitra-visit-reason",
...
//                 voice: {
//                   used:
//                     isRecording || Boolean(customReason.trim()),
//                   lang: whisperLang || "auto",
//                 },
//               },
//             },
...
//         try {
//           const raw =
//             sessionStorage.getItem("kioskSelectedAppointmentRaw");
//           if (raw) {
//             const appt = JSON.parse(raw);
//             const status = String(
//               appt?.payment?.status || appt?.status || ""
...
//       toast({
//         title: t(
//           "reason.visitReasonRecordedTitle",
//           "Visit Reason Recorded"
//         ),
//         description: t(
//           "reason.visitReasonRecordedDesc",
...
//         variant: "destructive",
//         title: t(
//           "reason.failedSaveTitle",
//           "Failed to save reason"
//         ),
//         description: e?.message || t("reason.failedSaveDesc", "Please try again."),
//       });
//     } finally {
//       setLoading(false);
//     }
...
//   // category header localization helper
//   const renderCategoryTitle = (category: string) => {
//     // If you want, later add reason.category.General etc. In the meantime, fallback to category itself.
//     return t(`reason.category.${category}`, category);
//   };
...
//       if (isProcessing) {
//         return t(
//           "reason.voiceStatusProcessing",
//           "Recording… (finalizing…)"
//         );
//       }
//       return t(
//         "reason.voiceStatusRecording",
//         "Recording… Click the mic to stop"
//       );
//     }
//     return t(
//       "reason.voiceStatusIdle",
//       "Click the mic to record and auto-transcribe your voice"
//     );
//   })();

//   return (
//     <KioskLayout title={t("reason.title", "Reason for Visit")}>
//       <div className="max-w-4xl mx-auto">
//         {/* Header */}
//         <div className="text-center mb-8">
//           <MessageSquare className="h-16 w-16 text-primary mx-auto mb-4" />
...
//                           className="text-xs"
//                         >
//                           {t("reason.selectedBadge", "Selected")}
//                         </Badge>
//                       )}
//                     </Button>
//                   );
...
//                 onChange={(e) => setCustomReason(e.target.value)}
//                 placeholder={t(
//                   "reason.otherDetailsPlaceholder",
...
//           <p className="text-sm text-muted-foreground mt-4">
//             {t(
//               "reason.additionalInfoNote",
//               "You can provide additional details about your symptoms, previous treatments, or any other relevant information by typing or using voice recording."
//             )}
//           </p>
//         </Card>
...
//                     {t(
//                       "reason.uploadDocsTitle",
//                       "Upload Medical Documents"
//                     )}
//                   </h3>
//                   <p className="text-sm text-muted-foreground">
//                     {t(
//                       "reason.uploadDocsSubtitle",
