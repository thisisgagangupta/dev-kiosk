...
//   // ---------- Age rule helpers ----------
//   const numericBirthYear = formData.yearOfBirth
//     ? Number(formData.yearOfBirth)
//     : NaN;
//   const computedAge =
//     Number.isFinite(numericBirthYear) &&
...
//         variant: "destructive",
//         title: t(
//           "walkin.errors.invalidMobileTitle",
//           "Invalid Mobile Number"
//         ),
//         description: t(
//           "walkin.errors.invalidMobileDesc",
...
//       if (!res.ok) {
//         const detail =
//           payload?.detail || `Failed to send OTP (${res.status})`;
//         throw new Error(detail);
//       }
...
//       setOtpSessionId(payload.otpSessionId || null);
//       toast({
//         title: t("walkin.otp.sentTitle", "OTP Sent"),
//         description: `${t(
//           "walkin.otp.sentDescPrefix",
//           "We’ve sent an OTP to"
//         )} ${payload.normalizedPhone || mobileDigits}.`,
//       });
//     } catch (e: any) {
//       toast({
//         variant: "destructive",
//         title: t("walkin.errors.otpSendFailedTitle", "OTP Send Failed"),
//         description:
//           e?.message ||
//           t(
//             "walkin.errors.otpSendFailedDesc",
//             "Could not send OTP. Please try again or contact front desk."
//           ),
//       });
//     } finally {
//       setOtpSending(false);
...
//       toast({
//         variant: "destructive",
//         title: t("walkin.errors.nameRequiredTitle", "Name Required"),
//         description: t(
//           "walkin.errors.nameRequiredDesc",
...
//         variant: "destructive",
//         title: t(
//           "walkin.errors.yobRequiredTitle",
//           "Year of Birth Required"
//         ),
//         description: t(
//           "walkin.errors.yobRequiredDesc",
...
//       toast({
//         variant: "destructive",
//         title: t("walkin.caregiverErrorTitle", "Caregiver Required"),
//         description: t(
//           "walkin.caregiverErrorDesc",
...
//       toast({
//         variant: "destructive",
//         title: t("walkin.errors.otpRequiredTitle", "OTP Required"),
//         description: t(
//           "walkin.errors.otpRequiredDesc",
...
//       toast({
//         title: t(
//           "walkin.registrationSuccessTitle",
//           "Registration Successful"
//         ),
//         description: data.created
//           ? t(
//               "walkin.registrationCreatedDesc",
//               "Your account has been created."
//             )
//           : t(
//               "walkin.registrationExistingDesc",
...
//         variant: "destructive",
//         title: t(
//           "walkin.errors.registrationFailedTitle",
//           "Registration Failed"
//         ),
//         description:
//           e?.message ||
//           t(
//             "walkin.errors.registrationFailedDesc",
//             "Please try again or see front desk."
//           ),
//       });
//     } finally {
//       setLoading(false);
...
//   // Group helper text with bold number in the middle
//   const groupHelperTemplate = t(
//     "walkin.groupSizeHelper",
//     "We’ll book __N__ time slot(s) for your group."
//   );
//   const [groupHelperBefore, groupHelperAfter] =
//     groupHelperTemplate.split("__N__");

//   return (
//     <KioskLayout title={t("walkin.title", "Walk-in Registration")}>
//       <div className="max-w-2xl mx-auto">
//         <div className="text-center mb-8">
//           <UserPlus className="h-16 w-16 text-primary mx-auto mb-4" />
//           <h1 className="text-3xl font-bold text-primary mb-4">
//             {t("walkin.title", "Walk-in Registration")}
//           </h1>
//           <p className="text-lg text-muted-foreground">
//             {t(
//               "walkin.subtitle",
...
//               >
//                 <Phone className="h-4 w-4" />
//                 {t("walkin.mobileLabel", "Mobile Number")}{" "}
//                 <span className="text-destructive">*</span>
//               </Label>
...
//                   onClick={handleSendOtp}
//                   disabled={
//                     otpSending || loading || mobileDigitsLen < 10
//                   }
//                   className="sm:w-auto"
//                 >
//                   {otpSending
...
//                       )
//                     : otpSent
//                     ? t("walkin.otp.resend", "Resend OTP")
//                     : t("walkin.otp.send", "Send OTP")}
//                 </Button>
...
//                     {t(
//                       "walkin.otp.helper",
//                       "Enter your mobile number and tap “Send OTP” to verify it."
//                     )}
//                   </p>
//                 )}
//               </div>
...
//                   >
//                     {t("walkin.otp.enterLabel", "Enter OTP")}
//                   </Label>
//                   <Input
//                     id="otp"
//                     type="text"
...
//               <Label className="text-lg font-medium flex items-center gap-2">
//                 <Calendar className="h-4 w-4" />
//                 {t("walkin.yearOfBirthLabel", "Year of Birth")}{" "}
//                 <span className="text-destructive">*</span>
//               </Label>
//               <Select
//                 value={formData.yearOfBirth}
//                 onValueChange={(value) =>
//                   handleInputChange("yearOfBirth", value)
//                 }
//                 disabled={loading}
//               >
//                 <SelectTrigger className="text-lg h-14">
...
//                 {t("walkin.genderLabel", "Gender (Optional)")}
//               </Label>
//               <Select
//                 value={formData.gender}
//                 onValueChange={(value) =>
...
//                     {t("walkin.gender.male", "Male")}
//                   </SelectItem>
//                   <SelectItem value="female">
//                     {t("walkin.gender.female", "Female")}
//                   </SelectItem>
//                   <SelectItem value="other">
//                     {t("walkin.gender.other", "Other")}
//                   </SelectItem>
//                   <SelectItem value="prefer-not-to-say">
//                     {t(
//                       "walkin.gender.preferNotToSay",
//                       "Prefer not to say"
//                     )}
//                   </SelectItem>
//                 </SelectContent>
...
//                     handleInputChange("hasCaregiver", !!checked)
//                   }
//                   disabled={loading}
//                 />
//                 <div className="flex flex-col gap-1">
...
//                       {t(
//                         "walkin.caregiverErrorDesc",
//                         "This patient appears to be under 15 years. Please confirm they are accompanied by a caregiver/guardian to continue."
//                       )}
//                     </p>
//                   )}
//                 </div>
...
//                 value={String(formData.groupSize)}
//                 onValueChange={(v) =>
//                   handleInputChange("groupSize", Number(v))
//                 }
//                 disabled={loading}
//               >
//                 <SelectTrigger className="text-lg h-14">
...
//               <p className="text-sm text-muted-foreground">
//                 {groupHelperBefore}
//                 <strong>{formData.groupSize}</strong>
//                 {groupHelperAfter}
//               </p>
//             </div>
//           </div>
...
//             size="lg"
//             disabled={
//               !isFormValid || loading || tooYoungWithoutCaregiver
//             }
//             className="w-full text-xl py-6 h-auto"
//           >
//             {loading ? (
//               <>
//                 <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin mr-2" />
//                 {t("walkin.buttons.registering", "Registering...")}
//               </>
//             ) : (
//               <>
//                 <UserPlus className="h-5 w-5 mr-2" />
//                 {t("walkin.buttons.proceed", t("common.proceed"))}
//               </>
//             )}
//           </Button>
