...
//           <div className="text-right text-xs text-muted-foreground">
//             <div>
//               {t("pharmacy.pickupTokenSourceLabel", "Source")}:{" "}
//               {tokenSource === "doctor"
//                 ? t(
//                     "pharmacy.pickupTokenSourceDoctor",
//                     "Doctor Visit"
...
//   // NEW: Walk-in search state
//   const [walkinSearch, setWalkinSearch] = useState("");

//   const filteredWalkinItems = useMemo(() => {
//     const q = walkinSearch.trim().toLowerCase();
//     if (!q) return [];
//     return walkinItems.filter((item) => {
//       const inName = item.name.toLowerCase().includes(q);
//       const inDosage = item.dosage.toLowerCase().includes(q);
//       const inQty = String(item.quantity).includes(q);
//       return inName || inDosage || inQty;
//     });
//   }, [walkinItems, walkinSearch]);
...
//         description: t(
//           "pharmacy.paymentCompleteDesc",
//           `Use token ${tok} at the pharmacy counter.`
//         ),
//       });
//       return;
//     }
...
//                   {walkinSearch.trim()
//                     ? t(
//                         "pharmacy.searchResultsHint",
//                         "Showing results matching your search."
//                       )
//                     : t(
//                         "pharmacy.searchStartTypingHint",
...
//               <div className="space-y-3">
//                 {walkinSearch.trim() && filteredWalkinItems.length === 0 && (
//                   <p className="text-sm text-muted-foreground">
//                     {t(
//                       "pharmacy.noMedicinesFound",
//                       "No medicines found. Please ask our staff for help."
//                     )}
//                   </p>
//                 )}
